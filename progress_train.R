...
# for (i in 1:nrow(progress_train_clean)){
#   progress_train_clean[i,"cohort"]<-substring((progress_train_clean[i,"cohort"]),1,4)
# }
# 
# ###### first term GPA
# progress_train_clean$first_term_GPA<-0
# for (i in 1:nrow(progress_train_clean)){
#   if (progress_train_clean[i,"cohort.term"]==1){
#     progress_train_clean[i,"first_term_GPA"]<-progress_train_clean[i,paste("TermGPA","Fall",progress_train_clean[i,"cohort"],sep="_")]
#   }
#   else if(progress_train_clean[i,"cohort.term"]==3){
#     if(progress_train_clean[i,paste("TermGPA","Fall",progress_train_clean[i,"cohort"],sep="_")]>0){
#       progress_train_clean[i,"first_term_GPA"]<-progress_train_clean[i,paste("TermGPA","Fall",progress_train_clean[i,"cohort"],sep="_")]
#     }
#     else
#       progress_train_clean[i,"first_term_GPA"]<-progress_train_clean[i,paste("TermGPA","Spring",as.numeric(progress_train_clean[i,"cohort"])+1,sep="_")]
#   }
# }
